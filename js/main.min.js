!function () {
    ...
    "use strict";
    const e = document.getElementById("tc"), t = document.getElementById("n_");
    ...
    if (e.length > 0) for (let n = 0; n < e.length; n++) {
        ...
        s.data = JSON.parse(s.el.getAttribute("data-price-input")), s.currentValEl = i.querySelector(".rz"), s.thumbSize = parseInt(window.getComputedStyle(s.currentValEl).getPropertyValue("--thumb-size"), 10);
    ...
    "use strict";
    const e = document.querySelectorAll(".rj");
    if (e.length > 0) for (let n = 0; n < e.length; n++) {
    ...
    function s() {
        var tb = document.getElementsByClassName("top-link");
        var d;
